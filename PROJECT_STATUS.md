...
8. **Mejoras de UX**
   ...
   - [x] ~~Mostrar descripción acortada en formato Markdown (visualización) en las cards del dashboard~~ ✅
   - [x] ~~Mostrar nombre completo del usuario en el sidebar (sin truncar)~~ ✅
